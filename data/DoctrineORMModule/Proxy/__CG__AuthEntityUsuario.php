 ...
 */
class Usuario extends \Auth\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Auth\\Entity\\Usuario' . "\0" . 'id', '' . "\0" . 'Auth\\Entity\\Usuario' . "\0" . 'login', '' . "\0" . 'Auth\\Entity\\Usuario' . "\0" . 'email', '' . "\0" . 'Auth\\Entity\\Usuario' . "\0" . 'senha', '' . "\0" . 'Auth\\Entity\\Usuario' . "\0" . 'nome', '' . "\0" . 'Auth\\Entity\\Usuario' . "\0" . 'role', '' . "\0" . 'Auth\\Entity\\Usuario' . "\0" . 'ativo', '' . "\0" . 'Auth\\Entity\\Usuario' . "\0" . 'criadoEm'];
        }
    ...
    public function setSenha(string $senhaHash): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSenha', [$senhaHash]);

        parent::setSenha($senhaHash);
    }
